/**
 * Task: Write a function that determines whether a driver is within the speed limit. 
...
function radar(speed, area) {
    ...
    if (speeding <= 20){
        ...
        statement = 'excessive speeding';
    } else {
        statement = 'reckless driving';
    }
    return(`The speed is ${speeding} km/h faster than the allowed speed of ${limit} - ${statement}`);
}