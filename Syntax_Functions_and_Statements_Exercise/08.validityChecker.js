/**
 * Task: Write a program that receives a total of 4 parameters in the format x1, y1, x2, y2. 
 ...
 * 
 * Note: You can use the following formula to help you calculate the distance between the points (x1, y1) 
 * and (x2, y2).
