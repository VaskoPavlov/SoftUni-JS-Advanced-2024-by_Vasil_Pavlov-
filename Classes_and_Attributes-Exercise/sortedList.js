/**
 * Task: Implement a class List, which keeps a list of numbers, sorted in ascending order. 
...
Input / Output
All functions that expect input will receive data as parameters. Functions that have validation 
will be tested with both valid and invalid data. Any result expected from a function should be 
returned as its result.
Your add and remove functions should return a class instance with the required functionality as 
its result. 
 */
class List {
    constructor() {
