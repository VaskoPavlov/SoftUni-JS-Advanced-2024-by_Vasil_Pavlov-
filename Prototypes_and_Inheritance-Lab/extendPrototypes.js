/**
 * Task: Write a function that receives a class and attaches to it a property species with the value 
 * "Human" and a function toSpeciesString(). When called, the function returns a string with the format:
