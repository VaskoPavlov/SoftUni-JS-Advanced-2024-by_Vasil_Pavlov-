/**
 * Task: Extend the Person and Teacher from the previous task and add a class Student inheriting 
 * from Person with additional property course. Add toString() functions to all classes, 
...
Input / Output
There will be NO input. Your function should return an object containing the classes Person, 
Teacher, and Student.
 */
