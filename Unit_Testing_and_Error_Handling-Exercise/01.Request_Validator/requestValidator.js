/**
 * Task: Write a function that validates an HTTP request object. The object has the properties method,
 *  uri, version, and message. Your function will receive the object as a parameter and has to verify
 *  that each property meets the following requirements:
•	method - can be GET, POST, DELETE or CONNECT
•	uri - must be a valid resource address or an asterisk (*); a resource address is a combination 
    of alphanumeric characters and periods; all letters are Latin; the URI cannot be an empty string
...
If any part fails the check, throw an Error with the message 
 ...
 */
/**
 * @param {Object} obj HTTP request Object
 * @returns {Object | Error} obj || Error
 */
